class_name DialogueManagerHisBalloon extends CanvasLayer
...
var crunch_sfx = load("res://audio/sfx/Explosion Sharp.wav")
...
func next(next_id: String) -> void:
	...
	#audio_stream_player.stream = open_sfx
	#audio_stream_player.play()

#attempting to add an area2d that can trigger the dialogue
...
func sfx_crunch() -> void:
	audio_stream_player.stream = crunch_sfx
	audio_stream_player.play()
#endregion
